...
from ...utils.reward_score import math_compute_score, r1v_compute_score, grounding_iou_score
...
class CustomRewardManager:
    def __init__(self, tokenizer: PreTrainedTokenizer, num_examine: int, compute_score: str):
        ...
        elif compute_score == "iou":
            self.compute_score: Callable[[str, str], RewardScore] = grounding_iou_score
        else:
